...
<head>
    ...
    <title>Inventory Guide - <?php echo APP_NAME; ?> Docs</title>
...
<body>
    ...
    <div class="docs-container">
        ...
        <main class="docs-content">
            ...
            <h1 class="doc-title">Inventory Management</h1>
            
            <div class="doc-body">
                <p>Master your stock levels with our powerful inventory management features.</p>

                <h2>Stock Levels</h2>
                <p>Your dashboard gives you a real-time view of stock levels. Products hitting the "Low Stock Alert" threshold will be highlighted so you can reorder in time.</p>

                <h2>Stock Adjustments</h2>
                <p>If you find discrepancies during a physical count (e.g., damaged goods or theft), use the <strong>Stock Adjustments</strong> module. You can increase or decrease stock levels and add a note explaining the reason.</p>

                <h2>Warehouses</h2>
                <p>If you have multiple storage locations, you can enable Multi-Warehouse support in Settings. This allows you to transfer stock between locations and track inventory per warehouse.</p>
            </div>
        </main>
    </div>
