    ...
    <nav class="navbar">
        <div class="container">
            <a href="#" class="nav-brand">
                <img src="https://dev.acculynce.com/public/uploads/logos/logo_1_1765731868.svg" alt="Acculynce Systems"
            ...
            <ul class="nav-menu">
                ...
                <li><a href="../modules/auth/login.php" class="btn-login">Sign In</a></li>
            </ul>
        </div>
    </nav>
            ...
            <div class="footer-grid">
                <div class="footer-col">
                    <a href="#" class="nav-brand footer-brand">
                        <img src="https://dev.acculynce.com/public/uploads/logos/logo_1_1765731868.svg"
